...
| 量化类型 | 描述 | 适用场景 | 配置示例 |
|----------|------|----------|----------|
| w8a8f8_mxfp_dynamic | 权重mxfp8 per-block对称量化，激活值mxfp8动态量化，FA fp8动态量化 | 昇腾950代际产品 | [wan2_2_w8a8f8_mxfp_t2v.yaml](../../../lab_practice/wan2_2/wan2_2_w8a8f8_mxfp_t2v.yaml) |
...
msmodelslim quant \
    ...
    --device npu \
    --model_type Wan2_2 \
    --config_path /lab_pratice/wan2_2/wan2_2_w8a8f8_mxfp_t2v.yaml \
...
msmodelslim quant \
    ...
    --device npu \
    --model_type Wan2_2 \
    --config_path /lab_pratice/wan2_2/wan2_2_w8a8f8_mxfp_i2v.yaml \
    --trust_remote_code True
```
...
msmodelslim quant \
    ...
    --device npu \
    --model_type Wan2_2 \
    --config_path /lab_pratice/wan2_2/wan2_2_w8a8f8_mxfp_ti2v.yaml \
    --trust_remote_code True
```
