...
| Qwen3-VL | W8A8SC量化 | [Qwen3-VL-8B-Instruct](https://huggingface.co/Qwen/Qwen3-VL-8B-Instruct)<br> | MindIE 预计3.0.RC1版本支持<br>vLLM Ascend 当前不支持 | [Qwen3-VL量化使用说明](./Qwen3-VL/README.md) |
