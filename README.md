...
具体模型接入请查看《[LLM大模型接入指南](./docs/zh/developer_guide/integrating_models.md)》以及《[多模态理解模型接入指南](./docs/zh/developer_guide/integrating_multimodal_understanding_model.md)》。
