...
脚本convert_example.py提供了将开源ChatGLM2-6B转换成msmodelslim量化权重的示例，权重获取链接见《[开源模型README](https://github.com/zai-org/ChatGLM2-6B?tab=readme-ov-file#%E4%BD%8E%E6%88%90%E6%9C%AC%E9%83%A8%E7%BD%B2)》中“低成本部署”章节，使用前请修改224行和225行的输入输出路径。使用方式`python convert_example.py`
...
`kv_cache_offset`为kvcache量化scale的偏移系数，数据类型、dtype、shape和scale一致
